        ...
        for (size_t i = 1; i < input_segments.size(); ++i) {
            ...
            if (denominator_zero && numinator_zero) {
                ...
                if (t > 0.0f && t < 1.0f) {
                    ...
                    Segment front_part(segment.get_start(), intersection_point, segment.get_texture_id(), segment.get_sector());
                    Segment back_part(intersection_point, segment.get_end(), segment.get_texture_id(), segment.get_sector());
