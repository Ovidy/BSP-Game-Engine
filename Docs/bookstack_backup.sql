...
(7,'page','Project Setup','project-setup',2,8,3,'2026-05-04 14:39:17','2026-05-04 15:47:16',NULL,1,1,1),
...
(1177,'Project','page',7,44),
(1178,'Setup','page',7,40),
(1179,'Now','page',7,1),
(1180,'we','page',7,2),
(1181,'ll','page',7,1),
(1182,'go','page',7,1),
(1183,'through','page',7,1),
(1184,'the','page',7,12),
(1185,'setup','page',7,2),
(1186,'process','page',7,1),
(1187,'Most','page',7,1),
(1188,'of','page',7,1),
(1189,'is','page',7,1),
(1190,'based','page',7,1),
(1191,'on','page',7,1),
(1192,'RayLib','page',7,2),
(1193,'s','page',7,3),
(1194,'Quickstart','page',7,2),
(1195,'Requirements','page',7,3),
(1196,'Build','page',7,4),
(1197,'Tools','page',7,1),
(1198,'Such','page',7,1),
(1199,'as','page',7,1),
...
(1201,'MinGW','page',7,1),
(1202,'VS','page',7,1),
(1203,'Builder','page',7,1),
(1204,'etc','page',7,1),
(1205,'Premake5','page',7,1),
(1206,'Included','page',7,1),
(1207,'in','page',7,3),
(1208,'build','page',7,3),
(1209,'directory','page',7,3),
(1210,'Add','page',7,3),
(1211,'Before','page',7,1),
(1212,'building','page',7,1),
(1213,'environment','page',7,2),
(1214,'should','page',7,2),
(1215,'create','page',7,1),
(1216,'a','page',7,2),
(1217,'new','page',7,1),
(1218,'project','page',7,5),
(1219,'Clone','page',7,1),
(1220,'repository','page',7,2),
(1221,'to','page',7,4),
(1222,'your','page',7,3),
(1223,'local','page',7,1),
(1224,'machine','page',7,1),
(1225,'Go','page',7,1),
(1226,'premake5','page',7,1),
(1227,'lua','page',7,1),
(1228,'premake5.lua','page',7,1),
(1229,'file','page',7,1),
(1230,'and','page',7,2),
(1231,'add','page',7,1),
(1232,'following','page',7,1),
(1233,'lines','page',7,1),
(1234,'========================================================','page',7,2),
(1235,'PROJECT','page',7,1),
(1236,'3','page',7,1),
(1237,'THE','page',7,1),
(1238,'GAME','page',7,1),
(1239,'Executable','page',7,1),
(1240,'workspaceName','page',7,1),
(1241,'kind','page',7,3),
(1242,'ConsoleApp','page',7,1),
(1243,'language','page',7,1),
(1244,'C++','page',7,1),
(1245,'targetdir','page',7,1),
(1246,'bin/%','page',7,2),
(1247,'cfg','page',7,3),
(1248,'buildcfg','page',7,3),
(1249,'cfg.buildcfg','page',7,3),
(1250,'objdir','page',7,1),
(1251,'obj/%','page',7,1),
(1252,'/Game','page',7,1),
(1253,'filter','page',7,13),
(1254,'system','page',7,8),
(1255,'windows','page',7,5),
(1256,'configurations','page',7,2),
(1257,'Release','page',7,2),
(1258,'action','page',7,5),
(1259,'gmake*','page',7,1),
(1260,'WindowedApp','page',7,2),
(1261,'buildoptions','page',7,3),
(1262,'Wl','page',7,1),
(1263,'-Wl','page',7,1),
(1264,'subsystem','page',7,1),
(1265,'-subsystem','page',7,1),
(1266,'vs*','page',7,4),
(1267,'entrypoint','page',7,1),
(1268,'mainCRTStartup','page',7,1),
(1269,'debugdir','page',7,1),
(1270,'$','page',7,1),
(1271,'SolutionDir','page',7,1),
(1272,'vpaths','page',7,1),
(1273,'Header','page',7,1),
(1274,'Files/*','page',7,3),
(1275,'=','page',7,3),
(1276,'Game/include/**','page',7,4),
(1277,'h','page',7,2),
(1278,'Game/include/**.h','page',7,2),
(1279,'hpp','page',7,2),
(1280,'Game/include/**.hpp','page',7,2),
(1281,'Source','page',7,1),
(1282,'Game/src/**','page',7,4),
(1283,'c','page',7,2),
(1284,'Game/src/**.c','page',7,2),
(1285,'cpp','page',7,2),
(1286,'Game/src/**.cpp','page',7,2),
(1287,'Game','page',7,5),
(1288,'Resource','page',7,1),
(1289,'Game/resources/**','page',7,2),
(1290,'Grab','page',7,1),
(1291,'source','page',7,1),
(1292,'code','page',7,1),
(1293,'ONLY','page',7,1),
(1294,'from','page',7,1),
(1295,'folder','page',7,1),
(1296,'files','page',7,2),
(1297,'The','page',7,2),
(1298,'needs','page',7,1),
(1299,'see','page',7,1),
(1300,'Engine','page',7,2),
(1301,'headers','page',7,1),
(1302,'includedirs','page',7,1),
(1303,'Engine/include','page',7,1),
(1304,'Game/include','page',7,1),
(1305,'external/glm','page',7,1),
(1306,'raylib_dir','page',7,1),
(1307,'/src','page',7,1),
(1308,'LINKING','page',7,1),
(1309,'links','page',7,7),
(1310,'AND','page',7,1),
(1311,'Raylib','page',7,1),
(1312,'BSPEngine','page',7,1),
(1313,'raylib','page',7,1),
(1314,'cdialect','page',7,1),
(1315,'C17','page',7,1),
(1316,'cppdialect','page',7,1),
(1317,'C++17','page',7,1),
(1318,'platform_defines','page',7,1),
(1319,'defines','page',7,2),
(1320,'_WINSOCK_DEPRECATED_NO_WARNINGS','page',7,1),
(1321,'_CRT_SECURE_NO_WARNINGS','page',7,1),
(1322,'characterset','page',7,1),
(1323,'Unicode','page',7,1),
(1324,'/Zc','page',7,1),
(1325,'__cplusplus','page',7,1),
(1326,'OS','page',7,1),
(1327,'SPECIFIC','page',7,1),
(1328,'SYSTEM','page',7,1),
(1329,'LINKS','page',7,1),
(1330,'_WIN32','page',7,1),
(1331,'winmm','page',7,1),
(1332,'gdi32','page',7,1),
(1333,'opengl32','page',7,1),
(1334,'libdirs','page',7,1),
(1335,'linux','page',7,3),
(1336,'stdc++','page',7,1),
(1337,'pthread','page',7,1),
(1338,'m','page',7,1),
(1339,'dl','page',7,1),
(1340,'rt','page',7,1),
(1341,'options','page',7,2),
(1342,'wayland=off','page',7,1),
(1343,'X11','page',7,1),
(1344,'wayland=on','page',7,1),
(1345,'wayland','page',7,3),
(1346,'client','page',7,1),
(1347,'wayland-client','page',7,1),
(1348,'cursor','page',7,1),
(1349,'wayland-cursor','page',7,1),
(1350,'egl','page',7,1),
(1351,'wayland-egl','page',7,1),
(1352,'xkbcommon','page',7,1),
(1353,'macosx','page',7,1),
(1354,'stdlib=libc++','page',7,1),
(1355,'-stdlib=libc++','page',7,1),
(1356,'c++','page',7,1),
(1357,'OpenGL','page',7,1),
(1358,'framework','page',7,7),
(1359,'OpenGL.framework','page',7,1),
(1360,'Cocoa','page',7,1),
(1361,'Cocoa.framework','page',7,1),
(1362,'IOKit','page',7,1),
(1363,'IOKit.framework','page',7,1),
(1364,'CoreFoundation','page',7,1),
(1365,'CoreFoundation.framework','page',7,1),
(1366,'CoreAudio','page',7,1),
(1367,'CoreAudio.framework','page',7,1),
(1368,'CoreVideo','page',7,1),
(1369,'CoreVideo.framework','page',7,1),
(1370,'AudioToolbox','page',7,1),
(1371,'AudioToolbox.framework','page',7,1),
(1372,'sure','page',7,2),
(1373,'that','page',7,2),
(1374,'you','page',7,2),
(1375,'replace','page',7,1),
(1376,'with','page',7,1),
(1377,'name','page',7,1),
(1378,'Also','page',7,1),
(1379,'make','page',7,1),
...
(1382,'list','page',7,1),
(1383,'src','page',7,1),
(1384,'include','page',7,1),
(1385,'resources','page',7,1),
(1386,'are','page',7,1),
(1387,'recommended','page',7,1),
(1388,'too','page',7,1),
(1389,'Environment','page',7,3),
(1390,'To','page',7,2),
(1391,'use','page',7,1),
(1392,'PreMake','page',7,2),
(1393,'run','page',7,1),
(1394,'for','page',7,1),
(1395,'check','page',7,1),
(1396,'out','page',7,1),
(1397,'section','page',7,1),
(1398,'Page','page',7,1),
...
(7,1,7,'page',14,'2026-05-04 14:51:38','2026-05-04 15:47:16'),
(8,1,8,'chapter',2,'2026-05-04 15:46:34','2026-05-04 15:46:36'),
...
-- Dump completed on 2026-05-04 15:49:04
