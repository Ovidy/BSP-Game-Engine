...
(10,'page','Creating a Simple Game','creating-a-simple-game',2,8,4,'2026-05-05 05:57:55','2026-05-07 13:32:10',NULL,1,1,1);
...
(1937,'game','page',7,1),
(2722,'Creating','page',10,40),
(2723,'a','page',10,43),
(2724,'Simple','page',10,40),
(2725,'Game','page',10,48),
(2726,'Introduction','page',10,3),
(2727,'We','page',10,3),
(2728,'re','page',10,1),
(2729,'going','page',10,1),
(2730,'to','page',10,3),
(2731,'create','page',10,1),
(2732,'simple','page',10,2),
(2733,'game','page',10,3),
(2734,'only','page',10,1),
(2735,'in','page',10,7),
(2736,'our','page',10,2),
...
(2745,'into','page',10,1),
(2746,'more','page',10,1),
(2747,'details','page',10,1),
(2748,'the','page',10,25),
(2749,'next','page',10,2),
(2750,'chapters','page',10,2),
(2751,'for','page',10,8),
(2752,'now','page',10,2),
(2753,'it','page',10,3),
(2754,'s','page',10,1),
(2755,'rather','page',10,1),
(2756,'All','page',10,2),
(2757,'of','page',10,5),
(2758,'used','page',10,2),
(2759,'resources','page',10,3),
(2760,'except','page',10,1),
(2761,'wabbit','page',10,1),
(2762,'sprite','page',10,1),
(2763,'that','page',10,2),
(2764,'be','page',10,4),
(2765,'this','page',10,3),
(2766,'tutorial','page',10,1),
(2767,'are','page',10,1),
(2768,'made','page',10,1),
(2769,'by','page',10,3),
(2770,'engine','page',10,4),
(2771,'creator','page',10,1),
(2772,'walk','page',10,1),
(2773,'through','page',10,1),
(2774,'each','page',10,1),
(2775,'step','page',10,1),
(2776,'creating','page',10,1),
(2777,'Include','page',10,3),
(2778,'Headers','page',10,3),
(2779,'//','page',10,23),
(2780,'1','page',10,2),
(2781,'Standard','page',10,2),
(2782,'IO','page',10,2),
(2783,'Stream','page',10,2),
(2784,'#include','page',10,8),
(2785,'iostream','page',10,1),
(2786,'2','page',10,2),
(2787,'Engine','page',10,7),
(2788,'Cores','page',10,2),
(2789,'bsp/handler','page',10,1),
(2790,'h','page',10,7),
(2791,'bsp/handler.h','page',10,1),
(2792,'render/handler','page',10,1),
(2793,'render/handler.h','page',10,1),
(2794,'input/handler','page',10,1),
(2795,'input/handler.h','page',10,1),
(2796,'3','page',10,2),
(2797,'Camera','page',10,7),
(2798,'bsp/camera','page',10,1),
(2799,'bsp/camera.h','page',10,1),
(2800,'4','page',10,1),
(2801,'Example','page',10,2),
(2802,'Level','page',10,3),
(2803,'test/level','page',10,1),
(2804,'test/level.h','page',10,1),
(2805,'5','page',10,1),
(2806,'RayLib','page',10,5),
(2807,'Related','page',10,2),
(2808,'RayLib-Related','page',10,2),
(2809,'Code','page',10,2),
(2810,'raylib','page',10,1),
(2811,'raylib.h','page',10,1),
(2812,'resource_dir','page',10,1),
(2813,'resource_dir.h','page',10,1),
(2814,'Debugging','page',10,1),
(2815,'core','page',10,1),
(2816,'systems','page',10,1),
(2817,'needed','page',10,1),
(2818,'running','page',10,1),
(2819,'BSP','page',10,7),
(2820,'calculations','page',10,1),
(2821,'rendering','page',10,2),
(2822,'and','page',10,13),
(2823,'user','page',10,2),
(2824,'input','page',10,3),
(2825,'Will','page',10,1),
(2826,'detailed','page',10,1),
(2827,'A','page',10,1),
(2828,'basic','page',10,2),
(2829,'3D','page',10,3),
(2830,'Player','page',10,1),
(2831,'Can','page',10,1),
(2832,'moved','page',10,1),
(2833,'multiple','page',10,1),
(2834,'ways','page',10,1),
(2835,'lookaround','page',10,2),
(2836,'all','page',10,2),
(2837,'axis','page',10,1),
(2838,'movement','page',10,2),
(2839,'Provided','page',10,1),
(2840,'testing','page',10,1),
(2841,'For','page',10,1),
(2842,'configurations','page',10,1),
(2843,'such','page',10,1),
(2844,'as','page',10,2),
(2845,'window','page',10,5),
(2846,'folder','page',10,1),
(2847,'finding','page',10,1),
(2848,'From','page',10,1),
(2849,'on','page',10,2),
(2850,'code','page',10,2),
(2851,'will','page',10,1),
(2852,'placed','page',10,1),
(2853,'function','page',10,4),
(2854,'int','page',10,1),
(2855,'Your','page',10,1),
(2856,'Initializations','page',10,6),
(2857,'Optional','page',10,2),
(2858,'Tell','page',10,1),
(2859,'use','page',10,2),
(2860,'vsync','page',10,1),
(2861,'work','page',10,1),
(2862,'high','page',10,1),
(2863,'DPI','page',10,1),
(2864,'displays','page',10,1),
(2865,'SetConfigFlags','page',10,1),
(2866,'FLAG_WINDOW_HIGHDPI','page',10,1),
(2867,'Must','page',10,2),
(2868,'Create','page',10,3),
(2869,'OpenGL','page',10,2),
(2870,'context','page',10,2),
(2871,'InitWindow','page',10,1),
(2872,'WINDOW_RESOLUTION','page',10,3),
(2873,'x','page',10,1),
(2874,'WINDOW_RESOLUTION.x','page',10,1),
(2875,'y','page',10,1),
(2876,'WINDOW_RESOLUTION.y','page',10,1),
(2877,'Set','page',10,3),
(2878,'target','page',10,1),
(2879,'FPS','page',10,1),
(2880,'60','page',10,3),
(2881,'so','page',10,1),
(2882,'loop','page',10,1),
(2883,'runs','page',10,1),
(2884,'at','page',10,2),
(2885,'consistent','page',10,1),
(2886,'speed','page',10,1),
(2887,'SetTargetFPS','page',10,1),
(2888,'Disable','page',10,1),
(2889,'cursor','page',10,1),
(2890,'camera','page',10,11),
(2891,'with','page',10,1),
(2892,'DisableCursor','page',10,1),
(2893,'Delta','page',10,5),
(2894,'Time','page',10,5),
(2895,'Delta-Time','page',10,5),
(2896,'fixed','page',10,1),
(2897,'world','page',10,1),
(2898,'objects','page',10,1),
(2899,'glm','page',10,5),
(2900,'float32_t','page',10,1),
(2901,'deltaTime','page',10,9),
(2902,'=','page',10,4),
(2903,'0f','page',10,6),
(2904,'0.0f','page',10,3),
(2905,'locate','page',10,1),
(2906,'6','page',10,2),
(2907,'7','page',10,2),
(2908,'coordinates','page',10,1),
(2909,'bsp','page',10,6),
(2910,'vec3','page',10,2),
(2911,'6.0f','page',10,1),
(2912,'CAM_HEIGHT','page',10,2),
(2913,'7.0f','page',10,1),
(2914,'60.0f','page',10,1),
(2915,'Handlers','page',10,1),
(2916,'Handler','page',10,4),
(2917,'bsp_handler','page',10,7),
(2918,'render','page',10,2),
(2919,'render_handler','page',10,8),
(2920,'input_handler','page',10,2),
(2921,'Resources','page',10,3),
(2922,'Loading','page',10,3),
(2923,'Game/resources','page',10,2),
(2924,'directory','page',10,1),
(2925,'easy','page',10,1),
(2926,'load','page',10,1),
(2927,'SearchAndSetResourceDir','page',10,1),
(2928,'Load','page',10,4),
(2929,'textures','page',10,1),
(2930,'using','page',10,1),
(2931,'Texture','page',10,1),
(2932,'Manager','page',10,1),
(2933,'load_texture','page',10,3),
(2934,'render_handler.load_texture','page',10,3),
(2935,'Wall1','page',10,1),
(2936,'png','page',10,3),
(2937,'Wall1.png','page',10,1),
(2938,'Monster1','page',10,1),
(2939,'north','page',10,1),
(2940,'Monster1-north.png','page',10,1),
(2941,'wabbit_alpha','page',10,1),
(2942,'wabbit_alpha.png','page',10,1),
(2943,'sectors','page',10,2),
(2944,'segments','page',10,2),
(2945,'from','page',10,1),
(2946,'example','page',10,2),
(2947,'level','page',10,2),
(2948,'load_level','page',10,1),
(2949,'bsp_handler.load_level','page',10,1),
(2950,'test_level_sectors','page',10,2),
(2951,'calculated','page',10,1),
(2952,'load_segments','page',10,1),
(2953,'render_handler.load_segments','page',10,1),
(2954,'get_segments','page',10,2),
(2955,'bsp_handler.get_segments','page',10,2),
(2956,'sprites','page',10,1),
(2957,'load_sprites','page',10,1),
(2958,'render_handler.load_sprites','page',10,1),
(2959,'test_level_sprites','page',10,1),
(2960,'Clamp','page',10,3),
(2961,'Prevention','page',10,3),
(2962,'recommended','page',10,3),
(2963,'First','page',10,1),
(2964,'add','page',10,3),
(2965,'declaration','page',10,1),
(2966,'top','page',10,1),
(2967,'below','page',10,2),
(2968,'includes','page',10,1),
(2969,'void','page',10,2),
(2970,'prevent_dt_clamp','page',10,3),
(2971,'float32_t&','page',10,2),
(2972,'Now','page',10,1),
(2973,'if','page',10,1),
(2974,'05f','page',10,1),
(2975,'0.05f','page',10,1),
(2976,'0166f','page',10,1),
(2977,'0.0166f','page',10,1),
(2978,'soon','page',10,1),
(2979,'Main','page',10,3),
(2980,'Loop','page',10,4),
(2981,'&','page',10,3),
(2982,'Window','page',10,3),
(2983,'Management','page',10,3),
(2984,'run','page',10,1),
(2985,'until','page',10,1),
(2986,'is','page',10,2),
(2987,'closed','page',10,1),
(2988,'while','page',10,1),
(2989,'WindowShouldClose','page',10,1),
(2990,'Update','page',10,2),
(2991,'calculate','page',10,1),
(2992,'GetFrameTime','page',10,1),
(2993,'pre_update','page',10,1),
(2994,'camera.pre_update','page',10,1),
(2995,'update','page',10,3),
(2996,'input_handler.update','page',10,1),
(2997,'get_map_renderer','page',10,1),
(2998,'render_handler.get_map_renderer','page',10,1),
(2999,'Ask','page',10,1),
(3000,'tree','page',10,1),
(3001,'what','page',10,1),
(3002,'nearby','page',10,1),
(3003,'std','page',10,1),
(3004,'vector','page',10,1),
(3005,'Sector','page',10,1),
(3006,'nearby_sectors','page',10,2),
(3007,'get_nearby_sectors','page',10,1),
(3008,'bsp_handler.get_nearby_sectors','page',10,1),
(3009,'get_pos_2d','page',10,3),
(3010,'camera.get_pos_2d','page',10,3),
(3011,'get_player_radius','page',10,1),
(3012,'camera.get_player_radius','page',10,1),
(3013,'Tree','page',10,1),
(3014,'Traverser','page',10,1),
(3015,'camera.update','page',10,1),
(3016,'bsp_handler.update','page',10,1),
(3017,'Render','page',10,1),
(3018,'Everything','page',10,1),
(3019,'render_handler.render','page',10,1),
(3020,'get_raylib_camera','page',10,1),
(3021,'camera.get_raylib_camera','page',10,1),
(3022,'get_segment_ids_to_render','page',10,1),
(3023,'bsp_handler.get_segment_ids_to_render','page',10,1),
(3024,'At','page',10,1),
(3025,'end','page',10,1),
(3026,'Destroy','page',10,1),
(3027,'cleanup','page',10,1),
(3028,'CloseWindow','page',10,1),
(3029,'return','page',10,1);
...
(2,1,2,'book',32,'2026-05-04 13:06:58','2026-05-04 15:48:52'),
...
(7,1,7,'page',17,'2026-05-04 14:51:38','2026-05-05 05:57:14'),
(8,1,8,'chapter',7,'2026-05-04 15:46:34','2026-05-05 05:58:23'),
(9,1,9,'page',1,'2026-05-04 15:48:51','2026-05-04 15:48:51'),
(10,1,10,'page',8,'2026-05-05 05:58:21','2026-05-07 13:32:10');
...
-- Dump completed on 2026-05-07 13:32:23
