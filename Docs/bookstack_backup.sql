...
(10,'page','Creating a Simple Game','creating-a-simple-game',2,8,4,'2026-05-05 05:57:55','2026-05-05 06:43:39',NULL,1,1,1);
...
(1937,'game','page',7,1),
(2477,'Creating','page',10,40),
(2478,'a','page',10,43),
(2479,'Simple','page',10,40),
(2480,'Game','page',10,47),
(2481,'Introduction','page',10,3),
(2482,'We','page',10,2),
(2483,'re','page',10,1),
(2484,'going','page',10,1),
(2485,'to','page',10,3),
(2486,'create','page',10,1),
(2487,'simple','page',10,2),
(2488,'game','page',10,3),
(2489,'only','page',10,1),
(2490,'in','page',10,7),
(2491,'our','page',10,2),
...
(2500,'into','page',10,1),
(2501,'more','page',10,1),
(2502,'details','page',10,1),
(2503,'the','page',10,14),
(2504,'next','page',10,2),
(2505,'chapters','page',10,2),
(2506,'for','page',10,8),
(2507,'now','page',10,2),
(2508,'it','page',10,2),
(2509,'s','page',10,1),
(2510,'rather','page',10,1),
(2511,'All','page',10,2),
(2512,'of','page',10,3),
(2513,'used','page',10,2),
(2514,'resources','page',10,3),
(2515,'except','page',10,1),
(2516,'wabbit','page',10,1),
(2517,'sprite','page',10,1),
(2518,'that','page',10,2),
(2519,'be','page',10,4),
(2520,'this','page',10,1),
(2521,'tutorial','page',10,1),
(2522,'are','page',10,1),
(2523,'made','page',10,1),
(2524,'by','page',10,3),
(2525,'engine','page',10,4),
(2526,'creator','page',10,1),
(2527,'walk','page',10,1),
(2528,'through','page',10,1),
(2529,'each','page',10,1),
(2530,'step','page',10,1),
(2531,'creating','page',10,1),
(2532,'Include','page',10,3),
(2533,'Headers','page',10,3),
(2534,'//','page',10,17),
(2535,'1','page',10,2),
(2536,'Standard','page',10,2),
(2537,'IO','page',10,2),
(2538,'Stream','page',10,2),
(2539,'#include','page',10,8),
(2540,'iostream','page',10,1),
(2541,'2','page',10,2),
(2542,'Engine','page',10,7),
(2543,'Cores','page',10,2),
(2544,'bsp/handler','page',10,1),
(2545,'h','page',10,7),
(2546,'bsp/handler.h','page',10,1),
(2547,'render/handler','page',10,1),
(2548,'render/handler.h','page',10,1),
(2549,'input/handler','page',10,1),
(2550,'input/handler.h','page',10,1),
(2551,'3','page',10,2),
(2552,'Camera','page',10,6),
(2553,'bsp/camera','page',10,1),
(2554,'bsp/camera.h','page',10,1),
(2555,'4','page',10,1),
(2556,'Example','page',10,2),
(2557,'Level','page',10,3),
(2558,'test/level','page',10,1),
(2559,'test/level.h','page',10,1),
(2560,'5','page',10,1),
(2561,'RayLib','page',10,5),
(2562,'Related','page',10,2),
(2563,'RayLib-Related','page',10,2),
(2564,'Code','page',10,2),
(2565,'raylib','page',10,1),
(2566,'raylib.h','page',10,1),
(2567,'resource_dir','page',10,1),
(2568,'resource_dir.h','page',10,1),
(2569,'Debugging','page',10,1),
(2570,'core','page',10,1),
(2571,'systems','page',10,1),
(2572,'needed','page',10,1),
(2573,'running','page',10,1),
(2574,'BSP','page',10,4),
(2575,'calculations','page',10,1),
(2576,'rendering','page',10,2),
(2577,'and','page',10,10),
(2578,'user','page',10,2),
(2579,'input','page',10,3),
(2580,'Will','page',10,1),
(2581,'detailed','page',10,1),
(2582,'A','page',10,1),
(2583,'basic','page',10,2),
(2584,'3D','page',10,3),
(2585,'Player','page',10,1),
(2586,'Can','page',10,1),
(2587,'moved','page',10,1),
(2588,'multiple','page',10,1),
(2589,'ways','page',10,1),
(2590,'lookaround','page',10,2),
(2591,'all','page',10,2),
(2592,'axis','page',10,1),
(2593,'movement','page',10,2),
(2594,'Provided','page',10,1),
(2595,'testing','page',10,1),
(2596,'For','page',10,1),
(2597,'configurations','page',10,1),
(2598,'such','page',10,1),
(2599,'as','page',10,2),
(2600,'window','page',10,3),
(2601,'folder','page',10,1),
(2602,'finding','page',10,1),
(2603,'From','page',10,1),
(2604,'on','page',10,2),
(2605,'code','page',10,2),
(2606,'will','page',10,1),
(2607,'placed','page',10,1),
(2608,'function','page',10,1),
(2609,'int','page',10,1),
(2610,'Your','page',10,1),
(2611,'Initializations','page',10,6),
(2612,'Optional','page',10,2),
(2613,'Tell','page',10,1),
(2614,'use','page',10,1),
(2615,'vsync','page',10,1),
(2616,'work','page',10,1),
(2617,'high','page',10,1),
(2618,'DPI','page',10,1),
(2619,'displays','page',10,1),
(2620,'SetConfigFlags','page',10,1),
(2621,'FLAG_WINDOW_HIGHDPI','page',10,1),
(2622,'Must','page',10,2),
(2623,'Create','page',10,3),
(2624,'OpenGL','page',10,1),
(2625,'context','page',10,1),
(2626,'InitWindow','page',10,1),
(2627,'WINDOW_RESOLUTION','page',10,3),
(2628,'x','page',10,1),
(2629,'WINDOW_RESOLUTION.x','page',10,1),
(2630,'y','page',10,1),
(2631,'WINDOW_RESOLUTION.y','page',10,1),
(2632,'Set','page',10,3),
(2633,'target','page',10,1),
(2634,'FPS','page',10,1),
(2635,'60','page',10,3),
(2636,'so','page',10,1),
(2637,'loop','page',10,1),
(2638,'runs','page',10,1),
(2639,'at','page',10,1),
(2640,'consistent','page',10,1),
(2641,'speed','page',10,1),
(2642,'SetTargetFPS','page',10,1),
(2643,'Disable','page',10,1),
(2644,'cursor','page',10,1),
(2645,'camera','page',10,3),
(2646,'with','page',10,1),
(2647,'DisableCursor','page',10,1),
(2648,'Delta','page',10,4),
(2649,'Time','page',10,4),
(2650,'Delta-Time','page',10,4),
(2651,'fixed','page',10,1),
(2652,'world','page',10,1),
(2653,'objects','page',10,1),
(2654,'glm','page',10,3),
(2655,'float32_t','page',10,1),
(2656,'deltaTime','page',10,1),
(2657,'=','page',10,1),
(2658,'0f','page',10,6),
(2659,'0.0f','page',10,3),
(2660,'locate','page',10,1),
(2661,'6','page',10,2),
(2662,'7','page',10,2),
(2663,'coordinates','page',10,1),
(2664,'bsp','page',10,5),
(2665,'vec3','page',10,2),
(2666,'6.0f','page',10,1),
(2667,'CAM_HEIGHT','page',10,2),
(2668,'7.0f','page',10,1),
(2669,'60.0f','page',10,1),
(2670,'Handlers','page',10,1),
(2671,'Handler','page',10,4),
(2672,'bsp_handler','page',10,4),
(2673,'render','page',10,1),
(2674,'render_handler','page',10,6),
(2675,'input_handler','page',10,1),
(2676,'Resources','page',10,3),
(2677,'Loading','page',10,3),
(2678,'Game/resources','page',10,2),
(2679,'directory','page',10,1),
(2680,'easy','page',10,1),
(2681,'load','page',10,1),
(2682,'SearchAndSetResourceDir','page',10,1),
(2683,'Load','page',10,4),
(2684,'textures','page',10,1),
(2685,'using','page',10,1),
(2686,'Texture','page',10,1),
(2687,'Manager','page',10,1),
(2688,'load_texture','page',10,3),
(2689,'render_handler.load_texture','page',10,3),
(2690,'Wall1','page',10,1),
(2691,'png','page',10,3),
(2692,'Wall1.png','page',10,1),
(2693,'Monster1','page',10,1),
(2694,'north','page',10,1),
(2695,'Monster1-north.png','page',10,1),
(2696,'wabbit_alpha','page',10,1),
(2697,'wabbit_alpha.png','page',10,1),
(2698,'sectors','page',10,2),
(2699,'segments','page',10,2),
(2700,'from','page',10,1),
(2701,'example','page',10,2),
(2702,'level','page',10,2),
(2703,'load_level','page',10,1),
(2704,'bsp_handler.load_level','page',10,1),
(2705,'test_level_sectors','page',10,2),
(2706,'calculated','page',10,1),
(2707,'load_segments','page',10,1),
(2708,'render_handler.load_segments','page',10,1),
(2709,'get_segments','page',10,2),
(2710,'bsp_handler.get_segments','page',10,2),
(2711,'sprites','page',10,1),
(2712,'load_sprites','page',10,1),
(2713,'render_handler.load_sprites','page',10,1),
(2714,'test_level_sprites','page',10,1),
(2715,'Clamp','page',10,3),
(2716,'Prevention','page',10,3),
(2717,'Main','page',10,3),
(2718,'Loop','page',10,3),
(2719,'&','page',10,3),
(2720,'Window','page',10,3),
(2721,'Management','page',10,3);
...
(10,1,10,'page',7,'2026-05-05 05:58:21','2026-05-05 06:43:39');
...
-- Dump completed on 2026-05-05  6:43:49
