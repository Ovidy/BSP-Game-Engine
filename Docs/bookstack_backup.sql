...
(10,'page','Creating a Simple Game','creating-a-simple-game',2,8,4,'2026-05-05 05:57:55','2026-05-05 06:33:28',NULL,1,1,1);
...
(1937,'game','page',7,1),
(2154,'Creating','page',10,40),
(2155,'a','page',10,42),
(2156,'Simple','page',10,40),
(2157,'Game','page',10,45),
(2158,'Introduction','page',10,3),
(2159,'We','page',10,2),
(2160,'re','page',10,1),
(2161,'going','page',10,1),
(2162,'to','page',10,1),
(2163,'create','page',10,1),
(2164,'simple','page',10,2),
(2165,'game','page',10,2),
(2166,'only','page',10,1),
(2167,'in','page',10,5),
(2168,'our','page',10,1),
...
(2177,'into','page',10,1),
(2178,'more','page',10,1),
(2179,'details','page',10,1),
(2180,'the','page',10,7),
(2181,'next','page',10,2),
(2182,'chapters','page',10,2),
(2183,'for','page',10,4),
(2184,'now','page',10,1),
(2185,'it','page',10,1),
(2186,'s','page',10,1),
(2187,'rather','page',10,1),
(2188,'All','page',10,2),
(2189,'of','page',10,2),
(2190,'used','page',10,2),
(2191,'resources','page',10,2),
(2192,'except','page',10,1),
(2193,'wabbit','page',10,1),
(2194,'sprite','page',10,1),
(2195,'that','page',10,1),
(2196,'be','page',10,3),
(2197,'this','page',10,1),
(2198,'tutorial','page',10,1),
(2199,'are','page',10,1),
(2200,'made','page',10,1),
(2201,'by','page',10,2),
(2202,'engine','page',10,4),
(2203,'creator','page',10,1),
(2204,'walk','page',10,1),
(2205,'through','page',10,1),
(2206,'each','page',10,1),
(2207,'step','page',10,1),
(2208,'creating','page',10,1),
(2209,'Include','page',10,3),
(2210,'Headers','page',10,3),
(2211,'//','page',10,5),
(2212,'1','page',10,1),
(2213,'Standard','page',10,2),
(2214,'IO','page',10,2),
(2215,'Stream','page',10,2),
(2216,'#include','page',10,8),
(2217,'iostream','page',10,1),
(2218,'2','page',10,1),
(2219,'Engine','page',10,5),
(2220,'Cores','page',10,2),
(2221,'bsp/handler','page',10,1),
(2222,'h','page',10,7),
(2223,'bsp/handler.h','page',10,1),
(2224,'render/handler','page',10,1),
(2225,'render/handler.h','page',10,1),
(2226,'input/handler','page',10,1),
(2227,'input/handler.h','page',10,1),
(2228,'3','page',10,1),
(2229,'Camera','page',10,3),
(2230,'bsp/camera','page',10,1),
(2231,'bsp/camera.h','page',10,1),
(2232,'4','page',10,1),
(2233,'Example','page',10,2),
(2234,'Level','page',10,2),
(2235,'test/level','page',10,1),
(2236,'test/level.h','page',10,1),
(2237,'5','page',10,1),
(2238,'RayLib','page',10,5),
(2239,'Related','page',10,2),
(2240,'RayLib-Related','page',10,2),
(2241,'Code','page',10,2),
(2242,'raylib','page',10,1),
(2243,'raylib.h','page',10,1),
(2244,'resource_dir','page',10,1),
(2245,'resource_dir.h','page',10,1),
(2246,'Debugging','page',10,1),
(2247,'core','page',10,1),
(2248,'systems','page',10,1),
(2249,'needed','page',10,1),
(2250,'running','page',10,1),
(2251,'BSP','page',10,1),
(2252,'calculations','page',10,1),
(2253,'rendering','page',10,1),
(2254,'and','page',10,3),
(2255,'user','page',10,1),
(2256,'input','page',10,1),
(2257,'Will','page',10,1),
(2258,'detailed','page',10,1),
(2259,'A','page',10,1),
(2260,'basic','page',10,2),
(2261,'3D','page',10,1),
(2262,'Player','page',10,1),
(2263,'Can','page',10,1),
(2264,'moved','page',10,1),
(2265,'multiple','page',10,1),
(2266,'ways','page',10,1),
(2267,'lookaround','page',10,1),
(2268,'all','page',10,1),
(2269,'axis','page',10,1),
(2270,'movement','page',10,1),
(2271,'Provided','page',10,1),
(2272,'testing','page',10,1),
(2273,'For','page',10,1),
(2274,'configurations','page',10,1),
(2275,'such','page',10,1),
(2276,'as','page',10,1),
(2277,'window','page',10,1),
(2278,'folder','page',10,1),
(2279,'finding','page',10,1),
(2280,'Initializations','page',10,6),
(2281,'Resources','page',10,3),
(2282,'Loading','page',10,3),
(2283,'Delta','page',10,3),
(2284,'Time','page',10,3),
(2285,'Delta-Time','page',10,3),
(2286,'Clamp','page',10,3),
(2287,'Prevention','page',10,3),
(2288,'Main','page',10,3),
(2289,'Loop','page',10,3),
(2290,'&','page',10,3),
(2291,'Window','page',10,3),
(2292,'Management','page',10,3);
...
(10,1,10,'page',5,'2026-05-05 05:58:21','2026-05-05 06:33:28');
...
-- Dump completed on 2026-05-05  6:33:42
